$(document).ready(function (){
    ...
    $('#user-registration-form').on('submit', function(e) {
        ...
        if (!checkName(fName)){
            displayError('first_name', 'First name must be at least 2 letters and contain only letters.');
            isValid = false;
        }

        if (!checkName(lName)){
            displayError('last_name', 'Last name must be at least 2 letters and contain only letters.');
            isValid = false;
        }
