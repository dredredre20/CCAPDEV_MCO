...
exports.getStudentHomepage = async (req, res) => {
...
exports.postEditReservation = async (req, res) => {
  ...
  try {
    ...
    try {
      ...
      // Handle duplicate key error
      if (saveError.code === 11000) {
        return res.redirect(`/student/edit-reservation?userId=${userId}&error=This seat has just been reserved by another student. Please choose a different seat.`);
      }
      throw saveError; // Re-throw other errors
    }
...
exports.getStudentProfile = async (req, res) => {
    ...
    try {
      ...
      // Add timestamp for cache busting
        ...
        // .populate('laboratory', 'name') // Populate lab name
